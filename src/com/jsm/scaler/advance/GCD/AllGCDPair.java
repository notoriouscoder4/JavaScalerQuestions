...
public class AllGCDPair {
    ...
    Explanation 1:
     ...
     8 and 10 are the gcd pair with itself.
     Therefore, [2, 8, 10] is the original array.

    Explanation 2:
     Initially, array A = [5, 5, 5, 15].
     5 is the gcd between 5 and 15.
     15 is the gcd pair with itself.
     Therefore, [5, 15] is the original array.
    */

    private static ArrayList<Integer> allGCDPair(ArrayList<Integer> A) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(allGCDPair(A));
    }
}
