...
public class Pubg {
    ...
    */
    ...
    private static int pubg(int[] A) {
        // It is always better for a person of weaker strength to attack the person of greater strength.
        // This is the way that we can get out the last standing person to have minimum strength.
        int ans = A[0];
