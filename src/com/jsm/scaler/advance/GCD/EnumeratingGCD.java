...
public class EnumeratingGCD {
    /*
    You are given a number A and a number B. The Greatest Common Divisor (GCD) of all numbers between A and B inclusive is taken (GCD(A, A+1, A+2 ... B)).
    ...
    Example Explanation
    The Greatest divisor that divides both 1 and 3 is 1.
    */
